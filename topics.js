...
var isAlertedReply = util.format('%s/A10b_IsAlertedReply/%s/%s/%s/%s/%s/%s/%s', MQID, MQTunnel, LGSSID);
var alertedReportReply = util.format('%s/A10a_AlertedReportReply/%s/%s/%s/%s/%s/%s/%s', MQID, MQTunnel, LGSSID);
var equipStatusReply = util.format('%s/A41a_EquipStatusReply/%s/%s/%s/%s/%s/%s/%s', MQID, MQTunnel, LGSSID);
// subscribe
